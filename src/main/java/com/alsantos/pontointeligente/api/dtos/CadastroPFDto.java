package com.alsantos.pontointeligente.api.dtos;
...
public class CadastroPFDto {
	...
	@Length(min = 6, max = 8, message = "Senha deve conter entre 6 e 8 caracteres.")
	...
	public String toString() {
		return "CatastroFuncionarioFDto [ id=" + id + ", nome=" + nome + ", email=" + email 
				+ ", senha=" + senha + ", cpf=" + cpf
				+ ", qtdHorasTrabalhoDia=" + qtdHorasTrabalhoDia 
				+ ", qtdHorasAlmoco=" + qtdHorasAlmoco
				+ ", valorHora=" + valorHora + ", cnpj=" + cnpj + " ]";
	}
}
